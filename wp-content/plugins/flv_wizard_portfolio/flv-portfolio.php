...
elseif($lightbox_type=="external")	{
	...
	$foutput.='<a title="'.__($port->post_title).'" class="portfolio" target="_blank" href="'.$urll.'">';
	 } 
...
elseif($lightbox_type=="external")	{
		$urll=get_post_meta($postid, 'flv_external_url', true);
	$func_output.='<a title="'.__($port->post_title).'" class="portfolio" target="_blank" href="'.$urll.'">';
	 } 
                    ...
                    $foutput.='<div id="portfolio-tabs-'.$count.'" class="portfolio-tabs">
                        ...
                        <section class="portfolio-tabs-detail">
                            ...
                            <div class="button raised dark-grey ripple">
                                <a target="_blank" href="'.esc_url($page_url).'">'.__('Read More Details', 'wizard').'</a>
                            </div>
                        </section>
