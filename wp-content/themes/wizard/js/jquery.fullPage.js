    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function addVerticalNavigation(){
            $body.append('<div id="' + SECTION_NAV + '" class="' + SECTION_NAV + '" ><ul></ul></div>');
        ...
        */
        ...
        $document.on('click touchstart', '.nav-menu' + ' .section_navi>a', function(e){ 
            e.preventDefault();
         jQuery(".sidebar-nav").trigger("sidebar:close");
		jQuery('.dropdown-menu ul').hide(300);
		
            var idx = $(this).parent().attr("data-menuanchor_idx");
            var index =  idx-1;
            scrollPage($(SECTION_SEL).eq(index));
        });
