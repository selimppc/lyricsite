<?php
if (!class_exists('WPBakeryShortCode_owl_slide_style1')) { 
class WPBakeryShortCode_owl_slide_style1 extends FLV_ShortCode {
...
vc_map( array(
    "name" => __("Owl slide style 1","wizard"),
    "base" => "owl_slide_style1",
    "icon" => "icon-map",
